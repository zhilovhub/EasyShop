<template>
  <FilterComponent @close="closeFilterComponent()" v-if="filterComponentIs"/>
  <div v-else-if="isLoading" class="loading-message">
    Загрузка...
  </div>
  <div v-else-if="responseStatus===406" class="loading-message">
    <div style="font-size: 24px; font-weight: 600; word-wrap: break-word; margin-bottom: 20px">Бот и магазин отключены администратором.</div>
  ...
  <div v-else-if="items.length === 0 && isLoading === false"
