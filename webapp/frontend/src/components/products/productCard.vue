<template>
  <div>
    ...
    <div v-for="(option, type) in productObject.extra_options">
      <div @click="option.isSelected = !option.isSelected" v-if="option.optionType === 'block-option'" class="block extra-options" :style="{ height: option.isSelected ? '' : '68.27px' }">
      ...
      <div @click="option.isSelected = !option.isSelected" v-else-if="option.optionType === 'text-option'" class="block" style="height: auto">
        <div class="span-block">
