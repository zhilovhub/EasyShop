...
Продлить подписку можно по кнопке ниже"""  # noqa

    SUBSCRIBE_END_NOTIFY_PART_2 = "Если подписка будет неактивна <b>больше месяца</b>, мы <b>удалим все данные</b> о Вашем боте"
