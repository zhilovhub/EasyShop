...
from bot.middlewaries.ban_middleware import BanCheckMiddleware
...
custom_bot_editing_router.message.outer_middleware(BanCheckMiddleware())
...
custom_bot_editing_router.callback_query.outer_middleware(BanCheckMiddleware())
...
admin_bot_menu_router.message.outer_middleware(BanCheckMiddleware())
...
admin_bot_menu_router.callback_query.outer_middleware(BanCheckMiddleware())
...
post_message_router.message.outer_middleware(BanCheckMiddleware())
...
post_message_router.callback_query.outer_middleware(BanCheckMiddleware())
...
channel_menu_router.message.outer_middleware(BanCheckMiddleware())
...
channel_menu_router.callback_query.outer_middleware(BanCheckMiddleware())
...
stock_menu_router.message.outer_middleware(BanCheckMiddleware())
stock_menu_router.callback_query.outer_middleware(BanCheckMiddleware())
...
subscribe_router.message.outer_middleware(BanCheckMiddleware())
subscribe_router.callback_query.outer_middleware(BanCheckMiddleware())
...
commands_router.message.outer_middleware(BanCheckMiddleware())
commands_router.callback_query.outer_middleware(BanCheckMiddleware())
...
payment_router.message.outer_middleware(BanCheckMiddleware())
payment_router.callback_query.outer_middleware(BanCheckMiddleware())
